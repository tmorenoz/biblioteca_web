...
class OAIPMHHarvester extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'oai:harvest {cantidad?}';
     ...
     * @var string
     */
    protected $description = 'Cosechador de OAI endpoint ESSALUD';
    ...
    protected function processData($sets, $params)
    {
        ...
        foreach ($sets as $currentSet) {
            ...
            echo "\n***************************************************************** \n";
            echo "\e[1;37;46m[ESTADO]\e[0m Set siendo procesado [$setCounter de $setCount]: $setName ($setTag) \n\n";
            sleep (30);
