...
@section('title')
Nosotros | EsSalud Biblioteca
@endsection
@section('content')

<span id='pestana_vista' valor='nosotros'></span>
<span id='pestana_responsive' valor='nosotro'></span>

<section class="banners banner m-top">
  <div class="banner__titulo">
    <h2 class="titulo titulo--mediano titulo--blanco">Nosotros</h2>
  </div>
