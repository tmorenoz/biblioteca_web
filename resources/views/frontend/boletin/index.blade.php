...
<section class="banners banner m-top">
  <div class="banner__titulo">
    <h2 class="titulo titulo--mediano titulo--blanco">Boletines</h2>
  </div>
  @php
        ...
        <div class="novedades__biblioteca row">
          <div class="col-lg-2 col-md-3 p-0">
            ...
            <div class="biblioteca">
              <select  class="selector" id="select-anio-boletin">
                @if($anio == 0)
          ...
          <div class="col-lg-2 col-md-3 p-0">
            ...
            <div class="biblioteca">
              <select  class="selector" id="select-mes-boletin">
                @if($mes == 0)
          ...
          @if($mes != 0 || $anio != 0)
            <div class="col-lg-2 col-md-3 p-0">
              <a href="{{ url('boletines') }}" class="btn-todos"><i class="fas fa-redo-alt"></i></a>
            </div>
          @endif
        </div>
      </div>
      ...
      <div class="col-lg-6 offset-lg-6 col-md-12 col-12">
        ...
        @foreach($boletines as $detalle)
          ...
          <div class="col-lg-3 col-md-6 col-12">
            <a href="{{url('boletines')}}/{{ $detalle->id }}/{{ $slug }}" class="novedades__card">
