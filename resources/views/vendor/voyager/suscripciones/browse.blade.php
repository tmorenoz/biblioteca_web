...
.voyager .modal-footer .btn.btn-danger {
...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('edit', app($dataType->model_name))
            ...
            @endif
        @endcan
        <form method="post" action="{{url('exportsuscriptor')}}" style="margin-left: 58px;">
          {{ csrf_field() }}
          <div class="form-group">
            ...
            <div class="col-sm-2" >
              <button type="submit" class="btn btn-warning" name="button" style="margin-top: -2px;"><i class="voyager-download"></i>Descargar</button>
            </div>
          </div>
        </form>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                   $date = property_exists($row->details, 'format') ? \Carbon\Carbon::parse($data->{$row->field})->formatLocalized($row->details->format) : $data->{$row->field} ;
                                                   // $my_dt = new DateTime($date);
                                                   $date->modify('-5 hours');
